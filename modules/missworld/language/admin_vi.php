...
$lang_module['chest_empty_error'] = 'Vòng ngực không được để trống';
$lang_module['chest_invalid_error'] = 'Vòng ngực phải lớn hơn 0';
$lang_module['waist_empty_error'] = 'Vòng eo không được để trống';
$lang_module['waist_invalid_error'] = 'Vòng eo phải lớn hơn 0';
...
$lang_module['view_votes'] = 'Danh sách vote';
$lang_module['close'] = 'Đóng';
$lang_module['id'] = 'ID';
$lang_module['vote_list'] = 'Danh sách bình chọn';
$lang_module['vote_list_for'] = 'Danh sách bình chọn cho';
$lang_module['voter_name'] = 'Họ tên người bình chọn';
